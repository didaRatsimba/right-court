...
public class ScoreNotifierService {
    ...
    public void notifyFoePoint(Integer count) {
        try {
            ...
            rabbitTemplate.convertAndSend(AMQPConfig.SCORE_QUEUE_EXCHANGE, "scores-java", getNotifyScore(Side.LEFT, count));
        } catch (Exception ex) {
    ...
    public void notifyMyPoint(Integer count) {
        try {
            ...
            rabbitTemplate.convertAndSend(AMQPConfig.SCORE_QUEUE_EXCHANGE, "scores-java", getNotifyScore(Side.RIGHT, count));
        } catch (Exception ex) {
